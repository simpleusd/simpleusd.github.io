...
The most Poly meme on Polygon. Join the Disciples of P as we follow Big P to eternal salvation and take over the Polygon Network.
Website: https://polygod.fun
...
contract PolyGod is ERC20, Ownable {
    ...
    constructor() ERC20("Poly God", "PYGD") {
        ...
        marketingWallet = pygdWallet;
        developmentWallet = pygdWallet;
        liquidityWallet = pygdWallet;

        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(deadAddress, true);
        excludeFromFees(pygdWallet, true);

        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(deadAddress, true);
        excludeFromMaxTransaction(address(uniswapV2Router), true);
        excludeFromMaxTransaction(pygdWallet, true);
    ...
    function heIsRisen() public onlyOwner {
